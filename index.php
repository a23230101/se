...
#+#
*/
$title = ''.ucwords(str_replace('-',' ',$q)).' - '.$config['1'].'';
...
<span typeof="v:Breadcrumb"><a property="v:title" rel="v:url" href="/">Audio & Video</a></span> / '.ucwords(str_replace('-',' ',$q)).'</div>
<div class="box" style="background:#cfc; color:#060; padding:10px;">WAPINI !! is an Audio & Video Search Engine. Our system now displays the results of '.ucwords(str_replace('-',' ',$q)).', use keywords that are easy to understand.
</div>';
...
$title = ''.$config['1'].' - '.$config['2'].'';
$deskripsi = '<meta name="description" content="'.htmlspecialchars($config['3'], ENT_QUOTES).'" />';
include 'system/include/_header.php';
