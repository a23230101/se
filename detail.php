...
$title = '[Audio] '.$audiotitle.' - '.$config['1'].'';
...
$title = '[Video] '.$videotitle.' - '.$config['1'].'';
...
$dsig = $as[decodedSignature];
$perlink = ''.$permalink.'&signature='.$dsig.'&title='.$videotitle.'';
...
$directlink = 'https://redirector.googlevideo.com/' . $directlink[1] . '';
$clean = '<div style="margin-bottom:5px; padding-bottom:2px ; border-bottom:1px solid #EEE;"><a target="_BLANK" href="'.$directlink.'&title='.$videotitle.'" rel="nofollow">'.$type.'</a> ('.size(bytes($permalink)).')</div> ';
$download = str_replace('<div style="margin-bottom:5px; padding-bottom:2px ; border-bottom:1px solid #EEE;"><a target="_BLANK" href="'.$directlink.'&title='.$videotitle.'" rel="nofollow"></a> ('.size(bytes($permalink)).')</div>','',$clean);
echo $download;
}
